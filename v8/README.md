...
llvm-cov-20 show -output-dir=/root/cov -instr-profile=/root/coverage.profdata /v8/v8/out/cov/d8  -format=html -compilation-dir=/v8/v8/out/cov
llvm-cov-20 report -instr-profile=/root/coverage.profdata /v8/v8/out/cov/d8
```
